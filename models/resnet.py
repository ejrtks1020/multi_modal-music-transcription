...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, top_channel_nums=2048, reduced_channel_nums=256, num_classes=76, scale=1):
        self.inplanes = 64
        ...
        self.layer4 = self._make_layer(block, top_channel_nums, layers[3], stride=2)

        self.FTB4 = FTB(top_channel_nums, 128)
        self.FRB4 = FRB(reduced_channel_nums, 128)
